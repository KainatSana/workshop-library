## Hi! Workshop Instructional Materials
...
1️⃣ | [Explore and Analyze Data with R](./full/explore-analyze-data-R/README.md) | Carlotta Casteluccio and Eric Wanjau | 2 hours | Clean and explore data with R | [🎥](https://youtu.be/VrVHaxarniY) | data, R |
...
2️⃣ | [Introduction to Regression Models with R and Tidymodels](./full/intro-regression-R-tidymodels/README.md) | Carlotta Casteluccio and Eric Wanjau | 2 hours | Using R, learn about Regression Models with Tidymodels |  | Regression, R |
...
2️⃣ | [Build a Minimal API with .NET 6](./full/intro-minapi/README.md) | Katie Savage | 1 hour | Build your first web API by building a Todo list. | | .NET 6, SQLite, [Build a web API with minimal API, ASP.NET Core, and .NET 6](https://docs.microsoft.com/learn/modules/build-web-api-minimal-api/) |
